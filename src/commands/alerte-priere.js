...
module.exports = {
    ...
    run: async (client, interaction, { errorEmbed, successEmbed }) => {
        ...
        try {
            ...
            // Now you can use the times object to access prayer times for different days

            // Example:
            const todayTimes = times[today.getDate() - 1]; // Adjusting to zero-based index
            console.log('Today\'s prayer times:', todayTimes.timings);
